...
const ERC20RouterTransfer: React.FC = () => {
	...
	const erc20Transfer = async () => {
		...
		try {
			...
			let userOpResponse = await biconomySmartAccount.sendTransaction(
				[tx1, tx2],
				{
					params: {
						batchSessionParams: [
			...
			if (success === "false") {
				...
				console.log("txHash", transactionHash);
				showSuccessMessage(
					`ERC20 Transfer ${transactionHash}`,
					transactionHash,
				);
				setLoading(false);
			}
	...
	return (
		<main className={classes.main}>
			...
			<p style={{ marginBottom: 20 }}>
				This is an example gasless transaction to transfer ERC20 tokens and mint
				NFT using the Batched Session Key Router Module.
			</p>
