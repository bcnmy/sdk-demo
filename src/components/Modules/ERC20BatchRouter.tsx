...
const ERC20Router: React.FC = () => {
  ...
  return (
    <main className={classes.main}>
      ...
      <h3 className={classes.subTitle}>ERC20 Transfer Batched Router</h3>

      <p style={{ marginBottom: 20 }}>
        This is an example gasless transaction to transfer ERC20 tokens using
        session key with batched router module.
      </p>
